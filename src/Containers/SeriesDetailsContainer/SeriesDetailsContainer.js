...
const SeriesDetailsContainer = () => {
    const { id } = useParams();
    const [seriesData, setSeriesData] = useState({});
    // const [castInfo, setCastInfo] = useState({});
    // const [youtube, setYoutube] = useState([]);

    const seriesDetailsData = () => {
    ...
    const { name, poster_path, overview, production_companies, production_countries, tagline, release_date, genres, vote_average, runtime } = seriesData
    return (
            ...
            <div className='main flex pl-[120px] pt-[80px] pb-[25px] gap-[20px] bg-black h-[540px]'>
                ...
                <div className='right w-[60%] flex flex-col gap-[16px] py-[30px]'>
                    <div className='flex items-center gap-[20px]'>
                        <h1 className='text-[#daa520] font-bold text-[36px] cursor-pointer hover:text-[#C0C0C0]'>{name}</h1>
